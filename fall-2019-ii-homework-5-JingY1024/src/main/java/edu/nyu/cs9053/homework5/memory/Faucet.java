...
public class Faucet {
    ...
    public static void main(String[] args) {
        ...
        // The water that be added to waters still exist after faucet is released.
        // Now think about how to fix it...
        // Naive idea: let the water be added to water has different references with the original one.
